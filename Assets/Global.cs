...
public class Global : MonoBehaviour
{
    ...
    void Start()
    {
         ...
         *     That might sound like a weird question, but it's actually a significant 
         *     one for asteroids if you want the game to play like Asteroids on  
         *     arbitrary screen dimensions.  It's mostly here for pedagogical reasons, though.
         *       The value that actually matters here is the depth value.  Since the gameplay
         *        takes place on a XZplane, and we're looking down the Y-axis, we're mainly
         *         interested in what the Y value of 0 maps to in the camera's depth. */
    ...
    void Update()
    {
        ...
        if (timer > spawnPeriod)
        {
            ...
            /* if you want to verify that this method works, uncomment this code. 
             * What will happen when it runs is that one object will be spawned at each corner of the screen,
             * regardless of the size of the screen. If you pause the Scene and inspect each object, you will
             * see that each has a Y-coordinate value of 0.
            */
            /*
